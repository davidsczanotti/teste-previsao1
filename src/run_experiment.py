# src/run_experiment.py (troque só a parte do get_prices)
...
def main():
    ...
    end = (pd.Timestamp.today().normalize() - BDay(7)).date().isoformat()  # <- AQUI
    ...
    yhat_df = train_predict_nhits(long_df, h=5, input_size=60, max_steps=300, freq="D")
    print(yhat_df.tail())
